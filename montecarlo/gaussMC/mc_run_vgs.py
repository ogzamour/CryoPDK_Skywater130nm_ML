...
from getIV import getIvVg

N_RUNS = 10000
SPICE_FILE = "paramMC_vgs_sweep.spice"
PARENT_DIR = Path("/home/oliviag/ngspice-skywater-sims/mc_output")
...
getIvVg(N_RUNS, output_dir, folder, paramV)
