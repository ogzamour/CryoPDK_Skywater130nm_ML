...
for idx, run in enumerate(lhs_runs):
    ...
    #'set wr_vecnames',
    'set wr_singlescale',
    f'wrdata {vds_file} vdd gate ax_id0 out_vth0 out_u0 out_rdsw out_nfactor out_vsat out_eta0 out_delta',
    ...
    f'wrdata {vgs_file} vdd gate ax_id2 out_vth0 out_u0 out_rdsw out_nfactor out_vsat out_eta0 out_delta',
