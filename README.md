...
## Montecarlo
To run a montecarlo simulation for all parameters on all device, run ```python latinHypercube.py``` in the montecarlo directory. The output will be in ```mc_output_lhc``` and all sweep data will be in 3 CSV files.
